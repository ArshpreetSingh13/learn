                        ...
                        <div class="row gy-4 bg-light pt-3 mt-5">
                            ...
                            <div class="col-md-12 ">
                                <input type="text" class="form-control rounded-3" name="name"
                                    placeholder="Tutorial Name" required="">
                            </div>


                            <div class="col-md-12 ">
                                <select name="course" id="" class="form-control  rounded-3">
                            ...
                            <div class="col-md-12 ">
                                <input type="file" class="form-control  rounded-3" name="thumbnail"
                                    placeholder="Upload your thumbnail" required="">
                            </div>


                            <div class="col-md-12">

                              <input type="text" name="video_link"  class="form-control  rounded-3"
...
if (isset($_REQUEST["submit_btn"])) {
    ...
    move_uploaded_file($tmp, "tutorials_img/" . $new_name);

    include("config.php");

    $query = "INSERT INTO `tutorial`( `name`, `course`, `thumbnail`, `video_link`, `description`, `tags`) VALUES ('$name','$course','$new_name','$video_link','$description','$tags')";
